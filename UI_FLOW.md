...
- The shared PBJ shell does not render a persistent bottom navigation bar on
  desktop or mobile. Users move through each canonical flow using its explicit
  Back and forward actions; Home continues to provide direct Projects access,
  and More continues to provide secondary workspace destinations.
